...
public class SaltItem extends OceanicEquipmentModElements.ModElement {
	@ObjectHolder("oceanic_equipment:salt")
	public static final Item block = null;
	public SaltItem(OceanicEquipmentModElements instance) {
		super(instance, 26);
	}
