...
package net.mcreator.oceanicequipment.gui;
...
import net.mcreator.oceanicequipment.procedures.WhenfishoilcreatorprocedureactiveProcedure;
import net.mcreator.oceanicequipment.OceanicEquipmentModElements;
import net.mcreator.oceanicequipment.OceanicEquipmentMod;
...
public class FishoilcreatorGUIGui extends OceanicEquipmentModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FishoilcreatorGUIGui(OceanicEquipmentModElements instance) {
		super(instance, 7);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("fishoilcreator_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				OceanicEquipmentMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("oceanic_equipment:textures/fishoilcreator_gui.png");
		@Override
		...
		if (slotID == 2 && changeType == 1) {
			{
				...
				WhenfishoilcreatorprocedureactiveProcedure.executeProcedure($_dependencies);
			}
		}
